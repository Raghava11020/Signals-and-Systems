...
\\
\solution There are a lot of yellow lines in between 440 to 10KHz .  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise. It clearly shows that tonal frequency is under 10KHz. And above 10KHz only noise is present.\\
...
\begin{figure}[htbp]
    ...
    \label{fig:pectrogram_with_noise}
\end{figure}
...
\\
\solution The key strokes as well as background noise is subdued in the audio.  Also,  the signal is blank for frequencies above 10KHz.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{figs/Spectrogramwithreduced-noise.png}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/3.2c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/3.2py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/5.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
%
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/6_sol.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{figs/yn_by_dft(1).png}
\end{figure}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/6.5.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/7.1.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{figs/filter audio comparision.png}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Raghava11020/Signals-and-Systems/blob/main/4/codes/filterresponse.py
\end{lstlisting}
\begin{figure}[htbp]
    \centering
