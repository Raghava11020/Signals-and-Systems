...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.505', 'Epsilon = 0.55', 'Epsilon = 0.58', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
plt.savefig("p1.png")
