...
we get $N\geq 4$ and $0.169 \leq \epsilon \leq 0.61$\\
...
\end{align}
Substituting respective values in \eqref{eq:Gain_eq_LP} we get $G_{LP}=0.6251$
\begin{align}
     H_{a,LP}(s_L) &= \frac{0.6251}{\brak{s_L-s_1}\brak{s_L-s_2}\brak{s_L-s_3}\brak{s_L-s_4}}\\
     &= \frac{0.6251}{s_{L}^4 + 1.5964s_L^3 + 2.2741s_L^2 + 1.6276s_L + 0.6373}\label{eq:design}
\end{align}
\begin{lstlisting}
...
\begin{align}
    H_{a,BP}\brak{s} &= \frac{896.08s^4}{17945.06s^8 + 2475.14s^7 + 7372.87s^6 + 750.02s^5 + 1104.65s^4 + 73.85s^3 + 71.49s^2 + 2.36s + 1.68} \label{eq:magnitude_bandpass_sdom}
\end{align}
...
\begin{align}
    H_{d,BP}(z) &= \frac{896.08z^8 -3584.32z^6 + 5376.48z^4 - 3584.32z^2 + 896.08}{13597.12z^8 - 59341.58z^7 + 107304.82z^6 - 98985.66z^5 + 54456.1z^4 - 37861.86z^3 + 41230.3z^2 - 26963.54z + 694.38)}
\end{align}
 \begin{lstlisting}
